...
class TestLoadBalancerTypesClient(object):
    ...
    def test_get_by_id(self, load_balancer_types_client, load_balancer_type_response):
        load_balancer_types_client._client.request.return_value = load_balancer_type_response
        load_balancer_type = load_balancer_types_client.get_by_id(1)
        load_balancer_types_client._client.request.assert_called_with(url="/load_balancer_types/1", method="GET")
    ...
    def test_get_list(self, load_balancer_types_client, two_load_balancer_types_response, params):
        ...
        load_balancer_types_client._client.request.assert_called_with(url="/load_balancer_types", method="GET", params=params)
    ...
    def test_get_all(self, load_balancer_types_client, two_load_balancer_types_response, params):
        load_balancer_types_client._client.request.return_value = two_load_balancer_types_response
    ...
    def test_get_by_name(self, load_balancer_types_client, one_load_balancer_types_response):
        load_balancer_types_client._client.request.return_value = one_load_balancer_types_response
