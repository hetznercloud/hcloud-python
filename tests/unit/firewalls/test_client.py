...
class TestBoundFirewall(object):
    ...
    def test_bound_firewall_init(self, firewall_response):
        bound_firewall = BoundFirewall(
            ...
            data=firewall_response['firewall']
        )
    ...
    def test_get_actions_list(self, hetzner_client, bound_firewall, response_get_actions, params):
        hetzner_client.request.return_value = response_get_actions
        result = bound_firewall.get_actions_list(**params)
        hetzner_client.request.assert_called_with(url="/firewalls/1/actions", method="GET", params=params)
    ...
    def test_get_actions(self, hetzner_client, bound_firewall, response_get_actions, params):
        hetzner_client.request.return_value = response_get_actions
    ...
    def test_update(self, hetzner_client, bound_firewall, response_update_firewall):
        ...
        firewall = bound_firewall.update(name="New Corporate Intranet Protection", labels={})
        hetzner_client.request.assert_called_with(url="/firewalls/1", method="PUT",
    ...
    def test_apply_to_resources(self, hetzner_client, bound_firewall, response_set_rules):
        hetzner_client.request.return_value = response_set_rules
    ...
    def test_remove_from_resources(self, hetzner_client, bound_firewall, response_set_rules):
        hetzner_client.request.return_value = response_set_rules
...
class TestFirewallsClient(object):
    ...
    def test_get_by_id(self, firewalls_client, firewall_response):
        ...
        firewalls_client._client.request.assert_called_with(url="/firewalls/1", method="GET")
    ...
    def test_get_list(self, firewalls_client, two_firewalls_response, params):
        ...
        firewalls_client._client.request.assert_called_with(url="/firewalls", method="GET", params=params)
    ...
    @pytest.mark.parametrize("firewall", [Firewall(id=1), BoundFirewall(mock.MagicMock(), dict(id=1))])
    def test_get_actions_list(self, firewalls_client, firewall, response_get_actions):
        ...
        firewalls_client._client.request.assert_called_with(url="/firewalls/1/actions", method="GET", params={})
    ...
    def test_update(self, firewalls_client, firewall, response_update_firewall):
        ...
        firewall = firewalls_client.update(firewall, name="New Corporate Intranet Protection", labels={})
        firewalls_client._client.request.assert_called_with(url="/firewalls/38", method="PUT",
                                                            json={"name": "New Corporate Intranet Protection",
                                                                  "labels": {}})
    ...
    def test_set_rules(self, firewalls_client, firewall, response_set_rules):
        ...
        actions = firewalls_client.set_rules(firewall, [
            FirewallRule(direction=FirewallRule.DIRECTION_IN, protocol=FirewallRule.PROTOCOL_ICMP,
                         source_ips=["0.0.0.0/0", "::/0"])])
        firewalls_client._client.request.assert_called_with(url="/firewalls/1/actions/set_rules", method="POST", json={
            "rules": [{"direction": "in", "protocol": "icmp", "source_ips": ["0.0.0.0/0", "::/0"]}]})
    ...
    def test_delete(self, firewalls_client, firewall):
        ...
        firewalls_client._client.request.assert_called_with(url="/firewalls/1", method="DELETE")
    ...
    @pytest.mark.parametrize("firewall", [Firewall(id=1), BoundFirewall(mock.MagicMock(), dict(id=1))])
    def test_remove_from_resources(self, firewalls_client, firewall, response_set_rules):
        firewalls_client._client.request.return_value = response_set_rules

        actions = firewalls_client.remove_from_resources(firewall, [
            FirewallResource(type=FirewallResource.TYPE_SERVER, server=Server(id=5))])
        firewalls_client._client.request.assert_called_with(
            url="/firewalls/1/actions/remove_from_resources",
            method="POST", json={
