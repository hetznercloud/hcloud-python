...
class TestBoundFirewall:
    ...
    def bound_firewall(self, client: Client):
        return BoundFirewall(client=client.firewalls, data=dict(id=1))
    ...
    def test_delete(self, request_mock: mock.MagicMock, client: Client, bound_firewall):
...
class TestFirewallsClient:
    ...
    def test_get_by_id(
        self, request_mock: mock.MagicMock, firewalls_client, firewall_response
    ):
    ...
    def test_get_by_name(
        self, request_mock: mock.MagicMock, firewalls_client, one_firewalls_response
    ):
    ...
    def test_create(
        self, request_mock: mock.MagicMock, firewalls_client, response_create_firewall
    ):
    ...
    def test_delete(self, request_mock: mock.MagicMock, firewalls_client, firewall):
