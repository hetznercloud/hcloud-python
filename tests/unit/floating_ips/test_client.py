...
class TestBoundFloatingIP:
    @pytest.fixture()
    def bound_floating_ip(self, request_mock: mock.MagicMock, client: Client):
        return BoundFloatingIP(client=client.floating_ips, data=dict(id=14))
...
class TestFloatingIPsClient:
    ...
    def test_get_by_id(
        self, request_mock: mock.MagicMock, floating_ips_client, floating_ip_response
    ):
