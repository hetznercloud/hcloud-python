...
class TestBoundVolume:
    ...
    def bound_volume(self, client: Client):
        return BoundVolume(client=client.volumes, data=dict(id=14))

    def test_bound_volume_init(self, client: Client, volume_response):
...
class TestVolumesClient:
    ...
    def test_get_by_id(
        self, request_mock: mock.MagicMock, volumes_client, volume_response
    ):
    ...
    def test_get_list(
        self, request_mock: mock.MagicMock, volumes_client, two_volumes_response, params
    ):
    ...
    def test_get_by_name(
        self, request_mock: mock.MagicMock, volumes_client, one_volumes_response
    ):
    ...
    def test_create_with_location(
        self, request_mock: mock.MagicMock, volumes_client, volume_create_response
    ):
    ...
    def test_create_negative_size(self, request_mock: mock.MagicMock, volumes_client):
    ...
    def test_create_wrong_location_server_combination(
        self, request_mock: mock.MagicMock, volumes_client, location, server
    ):
        with pytest.raises(ValueError) as e:
            volumes_client.create(
