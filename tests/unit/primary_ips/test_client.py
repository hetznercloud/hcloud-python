...
class TestBoundPrimaryIP:
    ...
    def bound_primary_ip(self, client: Client):
        return BoundPrimaryIP(client=client.primary_ips, data=dict(id=14))
...
class TestPrimaryIPsClient:
    ...
    def test_get_by_id(
        self, request_mock: mock.MagicMock, primary_ips_client, primary_ip_response
    ):
    ...
    def test_get_by_name(
        self, request_mock: mock.MagicMock, primary_ips_client, one_primary_ips_response
    ):
