...
class TestBoundPlacementGroup:
    ...
    def bound_placement_group(self, client: Client):
        return BoundPlacementGroup(client=client.placement_groups, data=dict(id=897))
    ...
    def test_delete(
        self, request_mock: mock.MagicMock, client: Client, bound_placement_group
    ):
