...
class TestBoundImage:
    ...
    def bound_image(self, client: Client):
        return BoundImage(client=client.images, data=dict(id=14))
...
class TestImagesClient:
    ...
    def test_get_by_id(
        self, request_mock: mock.MagicMock, images_client, image_response
    ):
    ...
    def test_get_list(
        self, request_mock: mock.MagicMock, images_client, two_images_response, params
    ):
    ...
    def test_get_by_name(
        self, request_mock: mock.MagicMock, images_client, one_images_response
    ):
    ...
    def test_update(
        self, request_mock: mock.MagicMock, images_client, image, response_update_image
    ):
        request_mock.return_value = response_update_image
    ...
    def test_change_protection(
        self, request_mock: mock.MagicMock, images_client, image, action_response
    ):
        request_mock.return_value = action_response
