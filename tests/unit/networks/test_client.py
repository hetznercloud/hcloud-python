...
class TestBoundNetwork:
    @pytest.fixture()
    def bound_network(self, request_mock: mock.MagicMock, client: Client):
        return BoundNetwork(client=client.networks, data=dict(id=14))
...
class TestNetworksClient:
    ...
    def test_get_by_id(
        self, request_mock: mock.MagicMock, networks_client, network_response
    ):
    ...
    def test_get_by_name(
        self, request_mock: mock.MagicMock, networks_client, one_network_response
    ):
    ...
    def test_create(
        self, request_mock: mock.MagicMock, networks_client, network_create_response
    ):
