...
class TestBoundSSHKey(object):
    ...
    def test_update(self, hetzner_client, bound_ssh_key, response_update_ssh_key):
        ...
        hetzner_client.request.assert_called_with(url="/ssh_keys/14", method="PUT", json={"name": "New name"})
...
class TestSSHKeysClient(object):
    ...
    def test_get_by_id(self, ssh_keys_client, ssh_key_response):
        ...
        ssh_keys_client._client.request.assert_called_with(url="/ssh_keys/1", method="GET")
    ...
    def test_create(self, ssh_keys_client, ssh_key_response):
        ...
        ssh_keys_client._client.request.assert_called_with(url="/ssh_keys", method="POST", json={"name": "My ssh key", "public_key": "ssh-rsa AAAjjk76kgf...Xt"})
    ...
    def test_delete(self, ssh_keys_client, ssh_key, generic_action):
        ...
        ssh_keys_client._client.request.assert_called_with(url="/ssh_keys/1", method="DELETE")
