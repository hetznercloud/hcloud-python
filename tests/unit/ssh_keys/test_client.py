...
class TestBoundSSHKey:
    ...
    def bound_ssh_key(self, client: Client):
        return BoundSSHKey(client=client.ssh_keys, data=dict(id=14))
...
class TestSSHKeysClient:
    ...
    def test_get_by_id(
        self, request_mock: mock.MagicMock, ssh_keys_client, ssh_key_response
    ):
    ...
    def test_get_by_name(
        self, request_mock: mock.MagicMock, ssh_keys_client, one_ssh_keys_response
    ):
